...
public class DVD extends Ouvrage{
    ...
    public DVD(String titre, byte ageMin, String dateParution, TypeOuvrage typeOuvrage, double prixLocation, String langue, String genre, List<Auteur> lauteur, long code, String dureeTotale, byte nbreBonus, List<String> autresLangues, List<String> sousTitres) {
