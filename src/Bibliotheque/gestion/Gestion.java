        ...
        switch (choix) {
            case 1:
                ...
                do {
                    ...
                    choix2 = sc.nextInt();
                    sc.skip("\n");
                } while (choix2 < 1 || choix2 > tl.length);

                System.out.println("résumé du livre ");
                String resume = sc.nextLine();
                o = new Livre(titre, ageMin, dp, ploc, langue, genre, isbn, nbrePages, tl[choix2-1], resume);
                ;
                break;
            case 2:
                System.out.println("code ");
                long code_cd = sc.nextLong();
                System.out.println("nombre plages ");
                byte nbrePlages = sc.nextByte();
                System.out.println("durée totale ");
                String dT_cd = sc.nextLine();
                o = new CD(titre, ageMin,dp,ploc,langue,genre,code_cd,nbrePlages,dT_cd);
                ;
                break;
            case 3:
                System.out.println("code ");
                ...
                byte nB = sc.nextByte();
                sc.skip("\n");
                o = new DVD(titre, ageMin,dp,ploc,langue,genre,code,dT,nB);
                ;
                break;
        }
        louv.add(o);
